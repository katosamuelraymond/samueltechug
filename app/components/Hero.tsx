    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        >
          {roles.map((role, i) => (
            <span key={role} className="flex items-center gap-2">
              <span className="text-zinc-300 text-lg sm:text-xl font-medium">{role}</span>
              {i < roles.length - 1 && <span className="text-orange-500 text-xl">·</span>}
            </span>
          ))}
        </motion.div>
        ...
        >
          ...
          I architect scalable systems and deliver complete end-to-end solutions.
        </motion.p>
        ...
        >
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.97 }}
            className="px-8 py-3.5 border border-zinc-600 hover:border-orange-500 text-zinc-300 hover:text-orange-400 font-semibold rounded-lg transition-colors duration-200 text-sm"
          >
            Get In Touch
          </motion.button>
        </motion.div>
        ...
        >
          <a href="https://github.com/katosamuelraymond" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-zinc-500 hover:text-orange-400 transition-colors">
          ...
          <a href="mailto:katosamuelraymondmarvinhosborn@gmail.com" aria-label="Email" className="text-zinc-500 hover:text-orange-400 transition-colors">
